...
using SpotToSpotMuzik.CommonUI;
using SpotToSpotMuzik.CommonUI.Services.Contracts;
using SpotToSpotMuzik.CommonUI.Services.Implementations;
using SpotToSpotMuzik.CommonUI.States;
...
using SpotToSpotMuzik.Server.Authorization;
using SpotToSpotMuzik.Server.Helpers;
using SpotToSpotMuzik.Server.Managers;
using SpotToSpotMuzik.Server.Middleware;
...
using SpotToSpotMuzik.Storage.Mapping;
...
using SpotToSpotMuzik.Server.Data;


namespace SpotToSpotMuzik.Server
{
    public class Startup
    {
        ...
        {
            var authAuthority = Configuration["SpotToSpotMuzik:IS4ApplicationUrl"].TrimEnd('/');
            ...
            else
            {
                ...
                if (Convert.ToBoolean(Configuration["SpotToSpotMuzik:UseLocalCertStore"]) == true)
                {
                    var certificateThumbprint = Configuration["SpotToSpotMuzik:CertificateThumbprint"];
            ...
            services.Configure<IdentityOptions>(options =>
            {
                ...
                if (Convert.ToBoolean(Configuration["SpotToSpotMuzik:RequireConfirmedEmail"] ?? "false"))
                {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseMiddleware<APIResponseRequestLoggingMiddleware>(Convert.ToBoolean(Configuration["SpotToSpotMuzik:EnableAPILogging:Enabled"] ?? "true"));

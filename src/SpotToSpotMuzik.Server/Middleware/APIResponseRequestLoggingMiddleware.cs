...
using SpotToSpotMuzik.Server.Middleware.Extensions;
...
namespace SpotToSpotMuzik.Server.Middleware
{
    ...
    public class APIResponseRequestLoggingMiddleware
    {
        ...
        public APIResponseRequestLoggingMiddleware(RequestDelegate next, bool enableAPILogging, IConfiguration configuration)
        {
            ...
            _ignorePaths = configuration.GetSection("SpotToSpotMuzik:ApiLogging:IgnorePaths").Get<List<string>>();
        }

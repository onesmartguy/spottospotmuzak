...
using SpotToSpotMuzak.Storage.Core;
using IdentityModel;
...
namespace SpotToSpotMuzak.Storage
{
    ...
    {
        public const string ApiName = "SpotToSpotMuzak_api";
        public const string ApiFriendlyName = "SpotToSpotMuzak API";
        public const string AppClientID = "SpotToSpotMuzak_spa";
        ...
        public static IEnumerable<IdentityServer4.Models.Client> GetClients()
        {
            ...
            return new List<IdentityServer4.Models.Client>
            {
                ...
                new IdentityServer4.Models.Client
                {
                    ...
                    ClientSecrets = new List<Secret> { new Secret { Value = "SpotToSpotMuzak".Sha512() }},
                    Enabled = true,

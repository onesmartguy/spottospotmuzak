...
using SpotToSpotMuzik.Storage.Core;
using IdentityModel;
...
namespace SpotToSpotMuzik.Storage
{
    ...
    {
        public const string ApiName = "SpotToSpotMuzik_api";
        public const string ApiFriendlyName = "SpotToSpotMuzik API";
        public const string AppClientID = "SpotToSpotMuzik_spa";
        ...
        public static IEnumerable<IdentityServer4.Models.Client> GetClients()
        {
            ...
            return new List<IdentityServer4.Models.Client>
            {
                ...
                new IdentityServer4.Models.Client
                {
                    ...
                    ClientSecrets = new List<Secret> { new Secret { Value = "SpotToSpotMuzik".Sha512() }},
                    Enabled = true,

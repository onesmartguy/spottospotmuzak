...
using SpotToSpotMuzak.Server.Middleware.Extensions;
...
namespace SpotToSpotMuzak.Server.Middleware
{
    ...
    public class APIResponseRequestLoggingMiddleware
    {
        ...
        public APIResponseRequestLoggingMiddleware(RequestDelegate next, bool enableAPILogging, IConfiguration configuration)
        {
            ...
            _ignorePaths = configuration.GetSection("SpotToSpotMuzak:ApiLogging:IgnorePaths").Get<List<string>>();
        }

...
using SpotToSpotMuzak.CommonUI;
using SpotToSpotMuzak.CommonUI.Services.Contracts;
using SpotToSpotMuzak.CommonUI.Services.Implementations;
using SpotToSpotMuzak.CommonUI.States;
...
using SpotToSpotMuzak.Server.Authorization;
using SpotToSpotMuzak.Server.Helpers;
using SpotToSpotMuzak.Server.Managers;
using SpotToSpotMuzak.Server.Middleware;
...
using SpotToSpotMuzak.Storage.Mapping;
...
using SpotToSpotMuzak.Server.Data;
...
namespace SpotToSpotMuzak.Server
{
    public class Startup
    {
        ...
        {
            var authAuthority = Configuration["SpotToSpotMuzak:IS4ApplicationUrl"].TrimEnd('/');
            ...
            else
            {
                ...
                if (Convert.ToBoolean(Configuration["SpotToSpotMuzak:UseLocalCertStore"]) == true)
                {
                    var certificateThumbprint = Configuration["SpotToSpotMuzak:CertificateThumbprint"];
            ...
            services.Configure<IdentityOptions>(options =>
            {
                ...
                if (Convert.ToBoolean(Configuration["SpotToSpotMuzak:RequireConfirmedEmail"] ?? "false"))
                {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseMiddleware<APIResponseRequestLoggingMiddleware>(Convert.ToBoolean(Configuration["SpotToSpotMuzak:EnableAPILogging:Enabled"] ?? "true"));
